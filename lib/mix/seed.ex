defmodule Mix.Tasks.Seed do
  ...
  defp seed_data() do
    ...
    Postgrex.query!(DB, "INSERT INTO Users(name, username, type, password_hash) VALUES($1, $2, $3, $4)",["Linus Styren", "linus.styren", "Lärare", Tuple.to_list(Map.fetch(Bcrypt.add_hash("asd1234"), :password_hash)) |> Enum.at(1)], pool: DBConnection.ConnectionPool)
    ...
    Postgrex.query!(DB, "INSERT INTO Classes(class_name, school_id) VALUES($1, $2)",["TE15", 2], pool: DBConnection.ConnectionPool)
